...
class YourBot(yaboli.Bot):
    """
    info about Jackbox and games of that nature, plus some easter eggs.
    """

    def __init__(self):
        super().__init__("jackBot")

    # set help and other settings here
    self.help_general = None
    self.help_specific = "I tell you about Jackbox games! Just ask (using jackbox in your question)! Use !jackboxspecifics for a list of games. I've added some easter eggs as well!\nMade by @DoctorNumberFour.\nUUID: ${uuid}"
    self.killable = True
    self.kill_message = "/me fucks off"
